...
public class IdiomPuzzleController {
    ...
    private static final String IdiomDictWinPath = "E:\\python_workspace\\coal_dict.txt";
    ...
    static {
        ...
        try {
            ...
            if ("Windows 10".equals(System.getProperty("os.name"))) {
                // win10 需对IO流读取给定编码格式
                reader = new BufferedReader(new InputStreamReader(new FileInputStream(IdiomDictWinPath),"UTF-8"));
            } else {
...
//        }
    ...
    private static String[] convertToPinyinStringArray(String sequence) {
        ...
        try {
            ...
            e.printStackTrace();
            System.out.println("乱码了吗：" + sequence);
        }
        return res;
    }
}
